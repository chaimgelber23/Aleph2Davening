# Cinematic Landing Page Builder — Aleph2Davening Edition
...
1. **"What's the brand name and one-line purpose?"** — Free text. Example: "Aleph2Davening — Learn Hebrew reading and Jewish prayer from absolute zero."
...
4. **"What should visitors do?"** — Free text. The primary CTA. Example: "Start learning free", "Download the app", "Begin your journey".
...
### Preset E — "Sacred Warmth" (Aleph2Davening Default)
- **Identity:** A calm, reverent study hall — warm wood tones, parchment textures, the feeling of opening an ancient book in a modern space. Wisdom meets accessibility.
- **Palette:** Deep Blue `#1B4965` (Primary), Accent Gold `#C6973F` (Accent), Warm Off-White `#FEFDFB` (Background), Near-Black `#2D3142` (Text/Dark), Forest Green `#4A7C59` (Success), Terracotta `#C17767` (Subtle Accent)
- **Typography:** Headings: "Inter" (tight tracking). Drama: "Playfair Display" Italic. Hebrew: "Noto Serif Hebrew". Data: `"IBM Plex Mono"`.
- **Image Mood:** Torah scrolls, warm candlelight, Jerusalem stone, old books, parchment textures, synagogue interiors, Hebrew calligraphy.
- **Hero line pattern:** "[Journey noun] from" (Bold Sans) / "[Destination word]." (Massive Serif Italic)
- **Special:** Hebrew text elements use RTL direction with Noto Serif Hebrew. All Hebrew MUST include nekudot (vowel points). Feature cards can include live Hebrew letter animations.
...
- **Sacred Warmth variant:** Hero can include a large Hebrew letter or word with nekudot, subtly animated (slow pulse or gentle float).
...
- *Sacred Warmth variant:* Hebrew letters cycle through with their English transliteration below.
...
- *Sacred Warmth variant:* Types out a Hebrew prayer word-by-word (RTL) with transliteration appearing below each word.
...
- *Sacred Warmth variant:* Shows a 7-day learning streak visualization with the Shabbat column highlighted in gold.
...
- **Sacred Warmth variant:** Can include a large Hebrew quote with translation, revealed word by word.
...
- **Sacred Warmth variant:** Animations can be: (1) Hebrew letter morphing between forms, (2) A siddur page with word-by-word highlight scanning across, (3) A progress bar filling as letters are "mastered".
...
- If pricing doesn't apply (e.g., free app like Aleph2Davening), convert this into a **"Get Started" section** with a single large CTA, testimonials, or a feature comparison.
...
## Aleph2Davening Quick-Start

If building for Aleph2Davening specifically, use these pre-filled answers:

1. **Brand:** "Aleph2Davening — Learn to read Hebrew and daven (pray) from absolute zero."
2. **Aesthetic:** Preset E — "Sacred Warmth"
3. **Value Props:**
   - "Master Hebrew letters and vowels through interactive drills with audio"
   - "Follow along with real prayers using word-by-word karaoke and 7 rabbi audio sources"
   - "Build a daily practice habit with spaced repetition and streak tracking"
4. **CTA:** "Start Learning Free"
