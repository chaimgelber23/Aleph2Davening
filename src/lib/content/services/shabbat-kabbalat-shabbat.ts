    ...
    // =========================================================================
    {
      ...
      items: [
        ...
        },
        {
          ...
          prayerId: 'mizmor-shir-shabbat',
          type: 'prayer',
          label: "Mizmor Shir L'Yom HaShabbat",
          labelHebrew: 'מִזְמוֹר שִׁיר לְיוֹם הַשַּׁבָּת',
          amud: {
            role: 'both',
            instruction: 'Psalm 92 — sung by the Levites in the Temple every Shabbat. Closes the Kabbalat Shabbat service.',
            physicalActions: ['stand'],
        ...
        },
        {
          ...
          type: 'prayer',
          label: 'Bameh Madlikin',
          labelHebrew: 'בַּמֶּה מַדְלִיקִין',
          amud: {
            role: 'both',
            instruction: 'Mishnah Shabbat chapter 2 — recited publicly between Kabbalat Shabbat and Maariv.',
            notes: 'The Talmud says reciting this Mishnah on Friday evening is a protection. It discusses the laws of Shabbat candle-lighting.',
          },
