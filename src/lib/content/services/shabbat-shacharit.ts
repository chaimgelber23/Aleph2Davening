  ...
  segments: [
    ...
    // =========================================================================
    {
      ...
      items: [
        ...
        },
        {
          ...
          amud: {
            role: 'both',
            instruction: 'Extra psalms recited on Shabbat: Psalms 19, 34, 90, 91, 135, 136, and 33. These are added only on Shabbat and Yom Tov.',
            notes: 'The Shabbat Pesukei D\'Zimra is significantly expanded with these tehillim. Psalm 19 — the heavens declare Hashem\'s glory. Psalm 34 — David\'s gratitude. Psalm 90 — Moshe\'s prayer. Psalm 91 — protection and trust. Psalms 135-136 — Hashem\'s greatness in creation and history. Psalm 33 — praise for Hashem\'s word.',
          },
          estimatedSeconds: 480,
        },
        {
          id: 'shabbat-pdzimra-mizmor-shir',
          ...
          amud: {
            role: 'both',
            instruction: 'Psalm 92 — the psalm specifically composed for Shabbat.',
            notes: 'Psalm 92 is called "A Song for the Shabbat Day." According to the Midrash, it was composed by Adam on the first Shabbat. It declares that on Shabbat we perceive how Hashem\'s justice ultimately prevails and the righteous flourish.',
          },
          estimatedSeconds: 90,
        },
        {
          ...
          prayerId: 'az-yashir',
          type: 'prayer',
          label: 'Az Yashir (Shirat HaYam)',
          labelHebrew: 'אָז יָשִׁיר',
          amud: {
            role: 'both',
            instruction: 'The Song of the Sea — the song Moshe and Israel sang after crossing the Red Sea.',
            notes: 'Shirat HaYam (Exodus 15) is one of the great songs of Torah. It is written in a unique "brick-on-brick" format in a Torah scroll. The Shabbat PD\'Z includes it as the culminating song of praise before Nishmat.',
          },
          estimatedSeconds: 120,
        },
        {
          id: 'shabbat-pdzimra-nishmat',
          prayerId: 'nishmat-kol-chai',
          type: 'prayer',
          label: 'Nishmat Kol Chai',
          labelHebrew: 'נִשְׁמַת כָּל חַי',
          amud: {
            role: 'both',
            instruction: 'A soaring prayer of gratitude said only on Shabbat, Yom Tov, and at the Pesach Seder.',
            notes: 'Nishmat Kol Chai ("the soul of every living being") is one of the most poetic prayers in the siddur. It declares that even if we had a thousand mouths and a thousand tongues, we could not sufficiently thank Hashem. It leads directly into Yishtabach, the closing blessing of PD\'Z.',
          },
    ...
    // =========================================================================
    {
      ...
      items: [
        ...
        {
          id: 'shabbat-shema-el-adon',
          prayerId: 'el-adon',
          type: 'prayer',
          label: 'El Adon',
          labelHebrew: 'אֵל אָדוֹן',
          amud: {
            role: 'both',
            instruction: 'A Shabbat piyyut (liturgical poem) embedded within Yotzer Or, praising Hashem as Master of all creation.',
            notes: 'El Adon is an alphabetical acrostic praising the luminaries Hashem created — the sun, moon, and stars. It is said only on Shabbat (not weekdays), replacing or supplementing parts of the Yotzer Or blessing. A beautiful poem of cosmic praise unique to the Shabbat morning.',
          },
          estimatedSeconds: 90,
        },
        {
    ...
    // =========================================================================
    {
      ...
      items: [
        ...
        {
          id: 'shabbat-torah-yekum-purkan',
          prayerId: 'yekum-purkan',
          type: 'prayer',
          label: 'Yekum Purkan',
          labelHebrew: 'יְקוּם פֻּרְקָן',
          amud: {
            role: 'both',
            instruction: 'Two Aramaic prayers said after the Haftarah on Shabbat — blessings for Torah scholars and for the entire congregation.',
            notes: 'Yekum Purkan ("May salvation arise") is recited in Aramaic, the vernacular of the Babylonian Jewish community where these prayers originated. The first paragraph blesses scholars and community leaders; the second blesses all members of the congregation. A beautiful communal prayer unique to Shabbat mornings.',
          },
          estimatedSeconds: 90,
        },
        {
          id: 'shabbat-torah-av-harachamim',
          prayerId: 'av-harachamim',
          type: 'prayer',
          label: 'Av HaRachamim',
          labelHebrew: 'אַב הָרַחֲמִים',
          amud: {
            role: 'both',
            instruction: 'A memorial prayer for Jewish martyrs, said before the Torah is returned to the Aron.',
            notes: 'Av HaRachamim ("Father of Mercy") was composed in the aftermath of the Crusades, in memory of Jewish communities massacred for kiddush Hashem. It is traditionally omitted on Shabbat Mevorchim and other special Shabbatot. It is recited before returning the Torah scroll to the Aron.',
          },
          estimatedSeconds: 60,
        },
        {
