  ...
  segments: [
      ...
      items: [
        ...
        },
        {
          ...
          amud: {
            ...
            physicalActions: ['stand'],
            notes: 'This blessing "opens" the Pesukei D\'Zimra section. Stand while reciting it. Hold the front two tzitzit during the blessing. (Ashkenaz: Baruch She\'amar comes first, before Hodu.)',
          },
          estimatedSeconds: 60,
        },
        {
        ...
        },
        {
          ...
          amud: {
            ...
            physicalActions: ['sit'],
            notes: 'Psalms 146–150 are the grand finale of praise before the Song of the Sea. Each psalm praises Hashem from a different angle — His faithfulness, power, creation, praise through music, and the ultimate cosmic Halleluyah.',
          },
          estimatedSeconds: 120,
        },
        {
    ...
    // =========================================================================
    {
      ...
      items: [
        ...
        {
          id: 'post-torah-reading-opening',
          type: 'instruction',
          label: 'Torah Reading Opening (Mon/Thu)',
          labelHebrew: 'הוֹצָאַת הַסֵּפֶר תּוֹרָה',
          amud: {
            role: 'both',
            instruction: 'On Mondays and Thursdays, the Torah is taken out for a public reading. The Ark is opened and the Torah is carried to the bimah while the congregation sings verses.',
            notes: 'Monday and Thursday are Torah reading days — the market days in Talmudic times, so that travelers would hear Torah. Three people are called up (aliyot).',
          },
          estimatedSeconds: 120,
        },
        {
          id: 'post-torah-reading',
          type: 'torah_reading',
          label: 'Torah Reading (3 Aliyot)',
          labelHebrew: 'קְרִיאַת הַתּוֹרָה',
          amud: {
            role: 'both',
            instruction: 'Three people are called up to the Torah (Kohen, Levi, Yisrael). Each person recites a blessing before and after their aliyah. Respond "Amen" after each blessing.',
            congregationResponse: 'בָּרוּךְ ה׳ הַמְבוֹרָךְ לְעוֹלָם וָעֶד',
            congregationResponseTransliteration: "Baruch Hashem ham'vorach l'olam va'ed",
            waitForCongregation: true,
            notes: 'Stand when the Torah passes by you. The reader (ba\'al korei) chants the text with the traditional trope (trop). Each aliyah honoree recites a blessing before and after their portion.',
          },
          estimatedSeconds: 480,
        },
        {
          id: 'post-torah-kaddish',
          prayerId: 'kaddish-half',
          type: 'kaddish',
          label: "Half Kaddish (after Torah)",
          labelHebrew: 'חֲצִי קַדִּישׁ',
          amud: {
            role: 'shaliach_tzibbur',
            instruction: 'Half Kaddish after the Torah reading, before returning the Torah to the Ark.',
            congregationResponse: 'אָמֵן. יְהֵא שְׁמֵהּ רַבָּא...',
            congregationResponseTransliteration: 'Amen. Yehei shmei rabba...',
            physicalActions: ['stand'],
            waitForCongregation: true,
        ...
        {
          id: 'post-torah-hagbah',
          type: 'instruction',
          label: 'Hagbah & Gelilah (Torah Raising)',
          labelHebrew: 'הַגְבָּהָה וּגְלִילָה',
          amud: {
            role: 'both',
            instruction: 'The Torah is lifted and shown to the congregation. Call out "V\'zot HaTorah!" together with the congregation. The Torah is then wrapped and returned to the Ark.',
            congregationResponse: 'וְזֹאת הַתּוֹרָה אֲשֶׁר שָׂם מֹשֶׁה',
            congregationResponseTransliteration: "V'zot HaTorah asher sam Moshe",
            notes: 'When the Torah is raised and the congregation sees the text, all call out this verse. The Ark is then closed.',
          },
          estimatedSeconds: 60,
        },
        {
        ...
        {
          id: 'post-shir-shel-yom',
          type: 'prayer',
          label: 'Shir Shel Yom',
          labelHebrew: 'שִׁיר שֶׁל יוֹם',
          amud: {
            role: 'both',
            instruction: 'The Psalm of the Day — a different psalm for each day of the week. Said at the very end of the service.',
            physicalActions: ['sit'],
            notes: 'Sunday: Psalm 24. Monday: Psalm 48. Tuesday: Psalm 82. Wednesday: Psalm 94. Thursday: Psalm 81. Friday: Psalm 93. These were the psalms sung by the Levites in the Holy Temple on each corresponding day.',
          },
          estimatedSeconds: 90,
        },
      ],
