  ...
  // ---- Ashrei ----
  {
    ...
    sections: [
      ...
      },
      {
        ...
        notes: 'Psalm 145 begins. Each verse starts with a successive letter of the aleph-bet. א (Aleph).',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-bet',
        sortOrder: 4,
        hebrewText: 'בְּכָל יוֹם אֲבָרְכֶךָּ וַאֲהַלְלָה שִׁמְךָ לְעוֹלָם וָעֶד',
        transliteration: 'B\'chol yom avar\'cheka, va\'ahal\'lah shimcha l\'olam va\'ed',
        translation: 'Every day I will bless You, and I will praise Your Name forever and ever',
        notes: 'ב (Bet) — a commitment to praise Hashem every single day, not just when things are good.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-gimel',
        sortOrder: 5,
        hebrewText: 'גָּדוֹל ה׳ וּמְהֻלָּל מְאֹד וְלִגְדֻלָּתוֹ אֵין חֵקֶר',
        transliteration: 'Gadol Adonai um\'hulal m\'od, v\'ligdulato ein cheiker',
        translation: 'Great is the Lord and much praised, and His greatness is beyond investigation',
        notes: 'ג (Gimel) — God\'s greatness is literally immeasurable; no human mind can fathom it.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-dalet',
        sortOrder: 6,
        hebrewText: 'דּוֹר לְדוֹר יְשַׁבַּח מַעֲשֶׂיךָ וּגְבוּרֹתֶיךָ יַגִּידוּ',
        transliteration: 'Dor l\'dor y\'shabach ma\'asecha, ug\'vurotecha yagidu',
        translation: 'Each generation will praise Your deeds to the next, and tell of Your mighty acts',
        notes: 'ד (Dalet) — the chain of praise from generation to generation, parent to child.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-hei',
        sortOrder: 7,
        hebrewText: 'הֲדַר כְּבוֹד הוֹדֶךָ וְדִבְרֵי נִפְלְאוֹתֶיךָ אָשִׂיחָה',
        transliteration: 'Hadar k\'vod hodecha, v\'divrei nifl\'otecha asichah',
        translation: 'The splendor of Your glorious majesty and Your wondrous deeds I will speak of',
        notes: 'ה (Hei) — meditating on God\'s majestic splendor and wonders.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-vav',
        sortOrder: 8,
        hebrewText: 'וֶעֱזוּז נוֹרְאוֹתֶיךָ יֹאמֵרוּ וּגְדֻלָּתְךָ אֲסַפְּרֶנָּה',
        transliteration: 'Ve\'ezuz nor\'otecha yomeiru, ug\'dulat\'cha asap\'renah',
        translation: 'They will speak of the might of Your awesome deeds, and I will tell of Your greatness',
        notes: 'ו (Vav) — others will speak of God\'s power, and I personally will recount His greatness.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-zayin',
        sortOrder: 9,
        hebrewText: 'זֵכֶר רַב טוּבְךָ יַבִּיעוּ וְצִדְקָתְךָ יְרַנֵּנוּ',
        transliteration: 'Zeicher rav tuv\'cha yabi\'u, v\'tzidkat\'cha y\'raneinu',
        translation: 'They will express the memory of Your abundant goodness, and sing joyfully of Your righteousness',
        notes: 'ז (Zayin) — remembering God\'s goodness brings spontaneous joyful song.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-chet',
        sortOrder: 10,
        hebrewText: 'חַנּוּן וְרַחוּם ה׳ אֶרֶךְ אַפַּיִם וּגְדָל חָסֶד',
        transliteration: 'Chanun v\'rachum Adonai, erech apayim ug\'dal chased',
        translation: 'Gracious and merciful is the Lord, slow to anger and great in kindness',
        notes: 'ח (Chet) — one of the 13 Attributes of Mercy. God is patient and overflowing with kindness.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-tet',
        sortOrder: 11,
        hebrewText: 'טוֹב ה׳ לַכֹּל וְרַחֲמָיו עַל כָּל מַעֲשָׂיו',
        transliteration: 'Tov Adonai lakol, v\'rachamav al kol ma\'asav',
        translation: 'The Lord is good to all, and His mercy is upon all His works',
        notes: 'ט (Tet) — God\'s goodness extends to every creature, not just the righteous.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-yod',
        sortOrder: 12,
        hebrewText: 'יוֹדוּךָ ה׳ כָּל מַעֲשֶׂיךָ וַחֲסִידֶיךָ יְבָרְכוּכָה',
        transliteration: 'Yoducha Adonai kol ma\'asecha, va\'chasidecha y\'var\'chuchah',
        translation: 'All Your works will thank You, Lord, and Your pious ones will bless You',
        notes: 'י (Yod) — all of creation, plus the righteous, express gratitude to Hashem.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-kaf',
        sortOrder: 13,
        hebrewText: 'כְּבוֹד מַלְכוּתְךָ יֹאמֵרוּ וּגְבוּרָתְךָ יְדַבֵּרוּ',
        transliteration: 'K\'vod malchut\'cha yomeiru, ug\'vurat\'cha y\'dabeiru',
        translation: 'They will speak of the glory of Your kingdom, and tell of Your might',
        notes: 'כ (Kaf) — proclaiming God\'s sovereignty and power to the world.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-lamed',
        sortOrder: 14,
        hebrewText: 'לְהוֹדִיעַ לִבְנֵי הָאָדָם גְּבוּרֹתָיו וּכְבוֹד הֲדַר מַלְכוּתוֹ',
        transliteration: 'L\'hodia livnei ha\'adam g\'vurotav, uch\'vod hadar malchuto',
        translation: 'To make known to mankind His mighty deeds, and the glorious majesty of His kingdom',
        notes: 'ל (Lamed) — the purpose: so that all people recognize God\'s greatness.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-mem',
        sortOrder: 15,
        hebrewText: 'מַלְכוּתְךָ מַלְכוּת כָּל עוֹלָמִים וּמֶמְשַׁלְתְּךָ בְּכָל דּוֹר וָדוֹר',
        transliteration: 'Malchut\'cha malchut kol olamim, u\'memshalt\'cha b\'chol dor vador',
        translation: 'Your kingdom is a kingdom of all worlds, and Your dominion is in every generation',
        notes: 'מ (Mem) — God\'s kingdom is eternal, spanning all time and all worlds.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-samech',
        sortOrder: 16,
        hebrewText: 'סוֹמֵךְ ה׳ לְכָל הַנֹּפְלִים וְזוֹקֵף לְכָל הַכְּפוּפִים',
        transliteration: 'Someich Adonai l\'chol hanoflim, v\'zokeif l\'chol hak\'fufim',
        translation: 'The Lord supports all who fall, and straightens all who are bent over',
        notes: 'ס (Samech) — God lifts up those who stumble and gives strength to the downtrodden. (The נ/Nun verse is omitted in the psalm.)',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-ayin',
        sortOrder: 17,
        hebrewText: 'עֵינֵי כֹל אֵלֶיךָ יְשַׂבֵּרוּ וְאַתָּה נוֹתֵן לָהֶם אֶת אָכְלָם בְּעִתּוֹ',
        transliteration: 'Einei chol eilecha y\'sabeiru, v\'Atah notein lahem et ochlam b\'ito',
        translation: 'The eyes of all look to You with hope, and You give them their food in its time',
        notes: 'ע (Ayin) — every creature depends on God for sustenance, and He provides at exactly the right moment.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        ...
        notes: 'פ (Pei) — THE key verse of Ashrei. God sustains all life. Say it with extra concentration (kavanah). If you missed it, go back and say it again.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei. Say this verse with extra concentration.',
        },
      },
      {
        id: 'ashrei-tzadi',
        sortOrder: 19,
        hebrewText: 'צַדִּיק ה׳ בְּכָל דְּרָכָיו וְחָסִיד בְּכָל מַעֲשָׂיו',
        transliteration: 'Tzadik Adonai b\'chol d\'rachav, v\'chasid b\'chol ma\'asav',
        translation: 'Righteous is the Lord in all His ways, and kind in all His deeds',
        notes: 'צ (Tzadi) — everything God does is righteous and kind, even when we don\'t understand it.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-kuf',
        sortOrder: 20,
        hebrewText: 'קָרוֹב ה׳ לְכָל קֹרְאָיו לְכֹל אֲשֶׁר יִקְרָאֻהוּ בֶאֱמֶת',
        transliteration: 'Karov Adonai l\'chol kor\'av, l\'chol asher yikra\'uhu ve\'emet',
        translation: 'The Lord is near to all who call upon Him, to all who call upon Him in truth',
        notes: 'ק (Kuf) — God is close to anyone who sincerely reaches out to Him.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-reish',
        sortOrder: 21,
        hebrewText: 'רְצוֹן יְרֵאָיו יַעֲשֶׂה וְאֶת שַׁוְעָתָם יִשְׁמַע וְיוֹשִׁיעֵם',
        transliteration: 'R\'tzon y\'rei\'av ya\'aseh, v\'et shav\'atam yishma v\'yoshi\'eim',
        translation: 'He fulfills the desire of those who fear Him, and hears their cry and saves them',
        notes: 'ר (Reish) — God responds to those who revere Him and cry out to Him.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-shin',
        sortOrder: 22,
        hebrewText: 'שׁוֹמֵר ה׳ אֶת כָּל אֹהֲבָיו וְאֵת כָּל הָרְשָׁעִים יַשְׁמִיד',
        transliteration: 'Shomeir Adonai et kol ohavav, v\'eit kol har\'sha\'im yashmid',
        translation: 'The Lord guards all who love Him, and all the wicked He will destroy',
        notes: 'ש (Shin) — God protects those who love Him.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-tav',
        sortOrder: 23,
        hebrewText: 'תְּהִלַּת ה׳ יְדַבֶּר פִּי וִיבָרֵךְ כָּל בָּשָׂר שֵׁם קָדְשׁוֹ לְעוֹלָם וָעֶד',
        transliteration: 'T\'hilat Adonai y\'daber pi, vivareich kol basar shem kodsho l\'olam va\'ed',
        translation: 'My mouth will speak the praise of the Lord, and all flesh will bless His holy Name forever and ever',
        notes: 'ת (Tav) — the final letter of the aleph-bet. The psalm concludes with a vision of all living things praising God together.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
      ...
      },
      {
        id: 'ashrei-closing',
        sortOrder: 24,
        hebrewText: 'וַאֲנַחְנוּ נְבָרֵךְ יָהּ מֵעַתָּה וְעַד עוֹלָם הַלְלוּיָהּ',
        transliteration: 'Va\'anachnu n\'vareich Kah me\'atah v\'ad olam, Hal\'luyah',
        translation: 'And we will bless God from now until forever, Halleluyah',
        notes: 'Psalm 115:18 — added as the closing verse after Psalm 145. We pledge to continue praising Hashem forever.',
        amud: {
          role: 'both',
          physicalActions: ['sit'],
          instruction: 'Sit for Ashrei',
